<? php
//
const COMPRESS_API_URL       = "https://api.tngrm.io";    
//
class COMPRESS_ENDPOINTS {
    // Added tangram endoints
    const CATEGORIES_URL                = COMPRESS_API_URL."/api/v3.0/external/upload/categories"; // /create
    const CREATE_CATEGORY               = COMPRESS_ENDPOINTS::CATEGORIES_URL."/create";
    //
    const GET_RESTREAMERS               = COMPRESS_API_URL."/api/v3.0/external/restreamers";
    ...
    const GET_UPLOADS                   = COMPRESS_API_URL."/api/v3.0/external/upload";
    ...
    const PRESIGNED_URL_S3              = COMPRESS_API_URL."/api/v3.0/external/upload/presignedUrl";
